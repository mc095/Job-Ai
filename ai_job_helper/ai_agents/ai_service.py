...
class AIService:
    ...
    def generate_interview_question(
        ...
        *,
        ...
        """
        Generate a single contextual interview question
        
        Args:
            job_description: Job role/description
            resume: Candidate's resume
            conversation_history: Previous Q&A history
        
        Returns:
            Interview question as string
        """
        ...
        prompt = f"""You are an experienced technical interviewer conducting a voice interview.
...
Generate ONE thoughtful, clear interview question that:
1. Is relevant to the job role
2. Follows naturally from the conversation
3. Is suitable for voice communication (clear, concise)
4. Assesses technical or behavioral competency
5. Takes 30-60 seconds to ask
...
Return ONLY the question text, no preamble."""
        ...
        try:
            if self._client:
                ...
                model = self._legacy_model.GenerativeModel(self._model_name)
    ...
    def generate_interview_feedback(
        ...
        *,
        ...
        prompt = f"""You are an expert interview evaluator. Analyze this mock interview and provide comprehensive feedback.
...
1. **Technical Competency** (score /10)
2. **Communication Skills** (score /10)
3. **Problem-Solving Approach** (score /10)
4. **Overall Performance** (score /10)

5. **Strengths**: What the candidate did well
6. **Areas for Improvement**: Specific suggestions
7. **Key Recommendations**: Actionable next steps

Format as clear, constructive markdown with scores and bullet points."""
